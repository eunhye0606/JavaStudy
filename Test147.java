...
○ java.lang.Math 클래스의 주요 상수 및 메소드
   ...
   - public static long asin(double a)
     : a 를 반올림하여 결과값을 반환한다.

   - public static double randon()
     : 0.0 ~ 1.0 사이의 난수(임의의 실수)를 발생시켜 반환한다.


※ 추상 클래스가 아님에도 불구하고, 인스턴스 생성 불가 경우.
   외부에서 접근 불가.
private 클래스
{ 
	public 클래스()
...
public class Test147
{
	public static void main(String[] args)
	{
		...
		*/
		...
		//--==>>0.0 ~ 1.0 사이의 난수 : 0.46496327600450793
		//--==>>0.0 ~ 1.0 사이의 난수 : 0.926658262434367
		//--==>>0.0 ~ 1.0 사이의 난수 : 0.9986369317335043
		// 0.0과 1.0은 안나옴 
		// 불편하니까 Random class 따로 존재!.
